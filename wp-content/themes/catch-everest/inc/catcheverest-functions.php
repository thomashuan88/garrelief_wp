...
function catcheverest_header_menu() { ?>
	<div id="header-menu navbar navbar-inverse">
        <div id="access" class="navbar-inner" role="navigation">
            <div class="container">
            <?php
                if ( has_nav_menu( 'primary', 'catcheverest' ) ) { 
                    $args = array(
                        'theme_location'    => 'primary',
                        'container_class' 	=> 'menu-header-container nav-collapse collapse navbar-responsive-collapse', 
                        'items_wrap'        => '<ul class="menu nav">%3$s</ul>' 
                    );
                    wp_nav_menu( $args );
                }
                else {
                    echo '<div class="menu-header-container nav-collapse collapse navbar-responsive-collapse">';
                    wp_page_menu( array( 'menu_class'  => 'menu nav' ) );
                    echo '</div>';
                }
            ?> 	         
        	</div>
